...
func CreateGenRequest(fds *descriptorpb.FileDescriptorSet, filesToGen ...string) *plugin_go.CodeGeneratorRequest {
...
func FilesToGenerate(req *plugin_go.CodeGeneratorRequest) []*descriptorpb.FileDescriptorProto {
